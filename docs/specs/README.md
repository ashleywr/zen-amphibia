...
This folder contains larger design and implementation specs.
...
- The roadmap stays at repo root because it is a project-wide top-level artifact.
- Active design coordination still lives in [docs/planning/README.md](/C:/WorkDir/Minecraft%20Mods/Amphibia/docs/planning/README.md).
