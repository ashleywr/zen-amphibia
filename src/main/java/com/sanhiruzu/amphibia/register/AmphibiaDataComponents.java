...
public class AmphibiaDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<FrogDNA>> FROG_DNA = 
        register("frog_dna", builder -> builder.persistent(FrogDNA.CODEC).networkSynchronized(FrogDNA.STREAM_CODEC));
