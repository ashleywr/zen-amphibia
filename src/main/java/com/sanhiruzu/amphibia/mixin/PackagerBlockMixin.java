...
public abstract class PackagerBlockMixin {
    ...
    private boolean amphibia$workerFrogportPassesThroughPackagerUse(boolean original, ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
